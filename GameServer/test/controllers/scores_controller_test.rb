...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { completiontime: @score.completiontime, name: @score.name } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { completiontime: @score.completiontime, name: @score.name } }
